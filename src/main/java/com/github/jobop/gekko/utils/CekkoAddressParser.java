...
public class CekkoAddressParser extends RpcAddressParser {
    ...
    public Url parse(final String url) {
        ...
        // uniqueKey = ip:port:gekko
        final String uniqueKey = ip + RemotingAddressParser.COLON + port + RemotingAddressParser.COLON + "gekko";
