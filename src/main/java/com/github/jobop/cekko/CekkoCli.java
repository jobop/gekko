package com.github.jobop.cekko;

import com.github.jobop.cekko.core.CekkoConfig;
import com.github.jobop.cekko.core.CekkoNode;
 ...
 */
public class CekkoCli {
    AtomicInteger hashStarted = new AtomicInteger(0);
    CekkoConfig conf;
    CekkoNode node;

    public CekkoCli(CekkoConfig conf) {
        this.conf = conf;
